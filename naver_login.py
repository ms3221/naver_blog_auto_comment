...
def auto_blog_comment(blogUrl: str, comment="blog 잘보고 갑니다."):
    ...
    try:
        ...
        time.sleep(3)
        driver.find_element(By.XPATH, '//*[@id="printPost1"]/tbody/tr/td[2]/div[3]/div[1]/div[2]').click()
        driver.find_element(By.XPATH, '//*[@id="printPost1"]/tbody/tr/td[2]/div[3]/div[1]/div[2]').click()
        
        time.sleep(2)
        driver.find_element(By.XPATH, f'//*[@id="naverComment_201_{blog_no}"]/div/div[5]/div[1]/form/fieldset/div/div/div[2]/div/label').click()
        time.sleep(2)
        pyperclip.copy(comment)
        pyautogui.hotkey("ctrl", "v")
        time.sleep(2)
        driver.find_element(By.XPATH, f'//*[@id="naverComment_201_{blog_no}"]/div/div[5]/div[1]/form/fieldset/div/div/div[6]/button').click()
        time.sleep(2)
